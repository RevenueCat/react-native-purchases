...
- (void)setOptions:(NSDictionary *)options {
    if (@available(iOS 15.0, *)) {
        ...
        if (offering && ![offering isKindOfClass:[NSNull class]]) {
            ...
            if (identifier) {
                RCPresentedOfferingContext *presentedOfferingContext = [self presentedOfferingContextFromOptions:options];
...
- (RCPresentedOfferingContext *)presentedOfferingContextFromOptions:(NSDictionary *)options {
    NSDictionary *presentedOfferingContextOptions = options[@"presentedOfferingContext"];
