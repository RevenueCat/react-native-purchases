...
// Google's official test rewarded-interstitial ad unit — safe to commit and
// always fills. Swap for your own AdMob unit (with its server-side verification
// URL pointed at RevenueCat) to grant a real reward.
const AD_UNIT_ID = 'ca-app-pub-3940256099942544/6978759866';
